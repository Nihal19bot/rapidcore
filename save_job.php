...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($cv_tmp, $cv_folder)) {
        $sql = "INSERT INTO job_applications (name, mobile, email, college, passing_year, domain, cv)
        ...
        echo "<script>alert('Failed to upload CV'); window.location.href='job.html';</script>";
    }
}
